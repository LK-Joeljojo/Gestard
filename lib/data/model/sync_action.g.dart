...
const SyncActionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _SyncActiontypeEnumValueMap,
    )
  },
...
SyncAction _syncActionDeserialize(
  ...
  object.type =
      _SyncActiontypeValueEnumMap[reader.readByteOrNull(offsets[3])] ??
          SyncActionType.declareArrival;
  return object;
}
...
P _syncActionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_SyncActiontypeValueEnumMap[reader.readByteOrNull(offset)] ??
          SyncActionType.declareArrival) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _SyncActiontypeEnumValueMap = {
  'declareArrival': 0,
  'validateArrival': 1,
  'createPlanning': 2,
  'updatePlanning': 3,
};
const _SyncActiontypeValueEnumMap = {
  0: SyncActionType.declareArrival,
  1: SyncActionType.validateArrival,
  2: SyncActionType.createPlanning,
  3: SyncActionType.updatePlanning,
};
...
extension SyncActionQueryFilter
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> syncedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'synced',
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> typeEqualTo(
      SyncActionType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: value,
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> typeGreaterThan(
    SyncActionType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> typeLessThan(
    SyncActionType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterFilterCondition> typeBetween(
    SyncActionType lower,
    SyncActionType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncActionQuerySortBy
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortBySynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'synced', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortBySyncedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'synced', Sort.desc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncActionQuerySortThenBy
  ...
  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenBySynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'synced', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenBySyncedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'synced', Sort.desc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<SyncAction, SyncAction, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension SyncActionQueryWhereDistinct
  ...
  QueryBuilder<SyncAction, SyncAction, QDistinct> distinctBySynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'synced');
    });
  }

  QueryBuilder<SyncAction, SyncAction, QDistinct> distinctByType() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncActionQueryProperty
  ...
  QueryBuilder<SyncAction, bool, QQueryOperations> syncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'synced');
    });
  }

  QueryBuilder<SyncAction, SyncActionType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
